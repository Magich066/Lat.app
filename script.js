...
const detailContent = Object.freeze({
  ...
  'Муса Евлоев': {
    image: wrestlingImages.gym,
    paragraphs: [
      'Евлоев выступал в греко-римском стиле, но его дисциплина, физическая готовность и отношение к тренировкам полезны для любой борцовской школы.',
      'Для сайта о вольной борьбе эту карточку можно воспринимать как пример спортивного характера: системная работа, уважение к тренеру и готовность выдерживать большой объём.',
      'Разница стилей важна: вольная борьба активно использует атаки в ноги, поэтому молодым спортсменам нужно отдельно развивать защиту ног, проходы и борьбу у края ковра.'
    ]
  },
